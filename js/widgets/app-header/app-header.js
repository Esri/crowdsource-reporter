    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        */
        postCreate: function () {
            ...
            on(this.shareButton, "click", lang.hitch(this, this._shareClicked));
        ...
        */
        _createShareDialogContent: function () {
            var shareContent, label, buttonsContainer;
            shareContent = domConstruct.create("div", {}, null);
            ...
            buttonsContainer = domConstruct.create("div", {}, shareContent);
